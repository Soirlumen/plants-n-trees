...
## jiný strom
python -m src.lsystem_visualizer.cli --preset oak-tree --iterations 6 --angle 27 --shrink-length 0.955 --shrink-radius 0.88 --start-length 0.36 --start-radius 0.08 --leaf-length 0.4 --leaf-width 0.13 --leaf-fork-angle 35 --stochasticity 4 --seed 23 --leaf-color leaf_light --show
...
## Trs "trávy" :D
uv run python -m src.lsystem_visualizer.cli --preset stochastic-grass --seed 12 --angle 10 --stochasticity 4 --start-length 0.22 --start-radius 0.012 --shrink-length 0.96 --shrink-radius 0.88 --no-leaves --output exports/ground_grass.obj --branch-color leaf_dark  --show
